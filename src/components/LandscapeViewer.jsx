...
const LandscapeViewer = ({
    ...
    return (
        <div className="landscape-viewer" style={{ width: '100%', height: '100%', display: 'flex', background: 'var(--bg-primary)', overflow: 'hidden', minHeight: 0, minWidth: 0 }}>
            <div className="viewer-media-container" style={{ flex: 3, background: '#000', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '2rem', minHeight: 0, minWidth: 0 }}>
                {item.isVideo ? (
                    <video ref={videoRef} src={mediaUrl} controls loop muted={isGlobalMute} style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '8px', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}></video>
                ) : (
