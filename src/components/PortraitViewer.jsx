    ...
    return (
        <div className="portrait-viewer" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', background: 'var(--bg-primary)', overflow: 'hidden', minHeight: 0, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', width: '100%', maxWidth: '1000px', height: '100%', background: 'var(--bg-secondary)', boxShadow: '0 0 50px rgba(0,0,0,0.5)', minHeight: 0, minWidth: 0 }}>
                <div className="viewer-media-container" style={{ flex: 1, position: 'relative', background: '#000', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 0, minWidth: 0 }}>
                    {item.isVideo ? (
                        <video ref={videoRef} src={mediaUrl} loop={isLoopEnabled} muted={isGlobalMute} onEnded={handleVideoEnded} style={{ width: '100%', height: '100%', objectFit: 'contain' }}></video>
                    ) : (
